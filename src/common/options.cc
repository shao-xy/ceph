...
std::vector<Option> get_global_options() {
  return std::vector<Option>({
    ...
    Option("adsl_mds_mon_debug_level_creq_mig_contention", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    ...
    .set_description("ADSLab: Sort children by name before building the load matrix")
    .set_default(0),

    Option("adsl_mds_migmode", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    ...
    Option("adsl_mds_bal_presetmax", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(8000)
    .set_description(""),

    Option("adsl_mds_bal_ifthreshold", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(0.08)
    .set_description(""),

    Option("adsl_mds_bal_ifenable", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(0)
    .set_description(""),

    Option("adsl_mds_disable_2_epoch_check", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(0)
    .set_description("ADSLab: Disable 2 epoch check of load balance"),
