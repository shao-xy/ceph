...
std::vector<Option> get_global_options() {
  return std::vector<Option>({
    ...
    Option("adsl_mds_predictor_trace_predict_lat", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_description("ADSLab: Trace prediction latency. For evaluation only. Values: 0 off, 1 on.")
    .set_default(0),
