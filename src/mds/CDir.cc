...
CDir::CDir(CInode *in, frag_t fg, MDCache *mdcache, bool auth) :
  ...
  dir_rep(REP_NONE),
  pop_me(ceph_clock_now(), this, mdcache->mds->balancer),
  pop_nested(ceph_clock_now(), this, mdcache->mds->balancer),
  pop_auth_subtree(ceph_clock_now(), this, mdcache->mds->balancer),
  pop_auth_subtree_nested(ceph_clock_now(), this, mdcache->mds->balancer),
